package com.example.imusicplayer.entity.lrc;
...
public class LyricView extends TextView {
	...
	Context con;
    Intent curintent;
	public void SetContent(Context con) {
		this.con = con;
		curintent=new Intent(GlobalUtils.ACTION_CUR_LRC);
	}
	...
	public void updateIndex(long time) {
		...
		if (index != -1) {
			...
			if ("".equals(nowsen) || !nowlrcsen.equals(nowsen)) {
				curintent.putExtra(GlobalUtils.EXTRA_CUR_LRC, sen.getContent());
				con.sendBroadcast(curintent);
				nowsen = nowlrcsen;
			}
